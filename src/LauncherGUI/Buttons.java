...
public class Buttons {
    ...
    public static void playButtonListener(JButton play, JFrame frame, JTextField[] customFields) {
        ...
        play.addActionListener(e -> {
            if (difficulty.equals("easy")
                ...
                try {
                    ...
                    boolean b = i <= 50 && i > 0;
                    if (!b) {
                        System.out.println("Number is out of bounds 1-50.");
                        customFields[0].setBackground(Color.RED);
                        return;
                    }
                } catch (Exception error){
                    customFields[0].setBackground(Color.RED);
                    System.out.println("Needs to be an integer 1 and 50.");
                    return;
                }
                ...
                try {
                    ...
                    customFields[1].setBackground(Color.RED);
                    System.out.println("Needs to be an integer between 1 and 50.");
                    return;
                }
